    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="חיפוש לפי שם, חדר, מייל, טלפון..."
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="bg-gray-950 border border-gray-800 rounded-xl pr-9 pl-3 py-2 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 w-64 md:w-72 transition-colors"
              />
            </div>
            ...
            {onOpenRoomModal && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-emerald-300 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 rounded-xl transition-all cursor-pointer"
              >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 rounded-xl shadow-lg shadow-emerald-500/20 transition-all cursor-pointer"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
          <div className="bg-gray-950/60 border border-gray-800/80 rounded-xl p-3.5">
            <div className="text-[11px] text-gray-400 flex items-center justify-between">
              <span>סך בעלי מצאי</span>
              <Users className="w-3.5 h-3.5 text-blue-400" />
            </div>
            <div className="text-xl font-black text-white mt-1">{totalHolders}</div>
          </div>
          ...
          <div className="bg-gray-950/60 border border-gray-800/80 rounded-xl p-3.5">
            ...
            <div className="text-xl font-black text-emerald-400 mt-1">
              {totalRoomsCount} <span className="text-xs font-normal text-gray-500">({holdersWithRooms} בעלי מצאי)</span>
            </div>
          </div>

          <div className="bg-gray-950/60 border border-gray-800/80 rounded-xl p-3.5">
            <div className="text-[11px] text-gray-400 flex items-center justify-between">
              <span>סך פריטים חתומים</span>
              <Package className="w-3.5 h-3.5 text-purple-400" />
            </div>
            <div className="text-xl font-black text-white mt-1">{totalAssignedItems}</div>
          </div>

          <div className="bg-gray-950/60 border border-gray-800/80 rounded-xl p-3.5">
            <div className="text-[11px] text-gray-400 flex items-center justify-between">
              <span>פריטים שנסרקו בפועל</span>
              <CheckCircle2 className="w-3.5 h-3.5 text-teal-400" />
            </div>
            <div className="text-xl font-black text-teal-300 mt-1">{totalSwept}</div>
          </div>
        </div>
      </div>
