...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl border border-gray-800 bg-gray-900/90 text-gray-100 shadow-xl transition-all',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-base sm:text-lg font-bold leading-tight tracking-tight text-white',
      className
    )}
    {...props}
  />
