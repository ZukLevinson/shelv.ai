    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg sm:text-xl font-bold text-white">סטטוס סריקת חדרים</h2>
        </div>

        <button
          onClick={onManageRooms}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/30 rounded-xl transition-all"
        >
      ...
      {rooms.length === 0 ? (
        <div className="bg-gray-900 border border-gray-800 border-dashed rounded-2xl p-8 text-center space-y-3 shadow-md">
          ...
          <div className="text-base font-bold text-white">טרם הוגדרו חדרים במערכת</div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-1.5 text-xs text-gray-400">
                  ...
                  <span>בעל מצאי: <strong className="text-gray-200">{room.holder_name}</strong></span>
                </div>
