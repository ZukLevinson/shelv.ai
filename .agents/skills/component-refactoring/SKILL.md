...
description: Refactor high-complexity React components into maintainable, well-structured sub-components and custom hooks. Use when components exceed complexity or line thresholds, when extracting state/effects into hooks, simplifying conditional logic, or breaking down monolithic components.
---
...
30:Tb95f,# Output refactoring analysis as JSON
...
# - complexity: normalized score 0-100 (target .ts`.
